...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-b from-sky-blue/20 via-cloud-white to-sunset-orange/20">
      ...
      <div className="absolute inset-0">
        ...
        <div className="animate-cloud-drift opacity-20" style={{animationDelay: '10s'}}>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <img 
          src={floatingCastle} 
          alt="Floating Castle" 
          className="w-full h-full object-cover opacity-80 animate-float"
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 min-h-screen flex items-center justify-center">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="absolute top-32 right-16 w-3 h-3 bg-sunset-orange rounded-full animate-sparkle" style={{animationDelay: '0.5s'}}></div>
          <div className="absolute bottom-32 left-20 w-2 h-2 bg-sky-blue rounded-full animate-sparkle" style={{animationDelay: '1s'}}></div>
          ...
          <div className="mb-12 animate-slide-up" style={{animationDelay: '0.2s'}}>
            ...
            <p className="text-base md:text-lg font-ghibli-body text-muted-foreground">
          ...
          <div className="absolute bottom-1/4 left-1/3 w-4 h-4 bg-gradient-to-br from-sky-blue to-magic-purple rounded-full animate-float opacity-40" style={{animationDelay: '1s'}}></div>
        </div>
      </div>
